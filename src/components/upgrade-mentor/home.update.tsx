...
export default function HomeUpgradeMentor({ session }: IPros) {
  ...
  const {
    ...
    isLoading: isLoading,
    mutate: mutate,
  }: SWRResponse<any> = useSWR(
    GLOBAL_URL + `/api/condition-update`,
    fetchData,
    {
          ...
          <ListItemAvatar>
            <Avatar
              sx={{
                ...
                backgroundColor: `${data?.post ? "#2e7d32" : "none"}`,
                color: `${data?.post ? "#f5f5f5" : "none"}`,
              }}
            >
              <CheckIcon />
            </Avatar>
        ...
        <ListItem>
          <ListItemAvatar>
            <Avatar
              sx={{
                border: "1px solid #80808080",
                backgroundColor: `${data?.like ? "#2e7d32" : "none"}`,
                color: `${data?.like ? "#f5f5f5" : "none"}`,
              }}
            >
              <CheckIcon />
            </Avatar>
        ...
        <ListItem>
          <ListItemAvatar>
            <Avatar
              sx={{
                border: "1px solid #80808080",
                backgroundColor: `${data?.dateCreate ? "#2e7d32" : "none"}`,
                color: `${data?.dateCreate ? "#f5f5f5" : "none"}`,
              }}
            >
              <CheckIcon />
            </Avatar>
